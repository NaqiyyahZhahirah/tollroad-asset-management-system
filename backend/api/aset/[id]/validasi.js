// PATCH /api/aset/:id/validasi → updateStatusValidasi (admin only)
...
const { updateStatusValidasi } = require('../../../src/controllers/aset.controller');
...
module.exports = async function handler(req, res) {
    ...
    if (req.method === 'PATCH') {
        return updateStatusValidasi(req, res);
    }
